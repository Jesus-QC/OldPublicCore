...
public class LobbyConfig : IConfig
{
    ...
    public string ServerName { get; set; } = "<color=#ff3995>C</color><color=#f6479f>u</color><color=#ed55a8>r</color><color=#e463b2>s</color><color=#db71bc>e</color><color=#d27fc5>d</color> <color=#c09ad8>(</color><color=#b7a8e2>∩</color><color=#aeb6ec>｀</color><color=#a5c4f5>-</color><color=#9cd2ff>´</color><color=#a5d6f7>)</color><color=#aed9ee>⊃</color><color=#b7dde6>━</color><color=#c0e1de>━</color><color=#c9e4d5>☆</color><color=#d2e8cd>ﾟ</color><color=#dbebc4>.</color><color=#e4efbc>*</color><color=#edf3b4>･</color><color=#f6f6ab>｡</color><color=#fffaa3>ﾟ</color>";
