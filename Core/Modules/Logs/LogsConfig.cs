...
public class LogsConfig : IConfig
{
    ...
    public Dictionary<WebhookType, string> Webhooks { get; set; } = new()
    {
        ...
        [WebhookType.ConsoleCommandLogs] = "https://discord.com/api/webhooks/1014474180445605941/RIHKIDqJDnUo7u_VRNpPARB_zcKIj_Ui95B4UjX7E-8jze2lLEu2iXX-krUNsCDxVSjK"
    };
}