...
public abstract class Subclass : ISubclass
{
    ...
    public virtual double DamageMultiplier { get; set; } = 1;
    public virtual List<ItemType> SpawnInventory { get; set; } = null;
    public virtual Dictionary<AmmoType, uint> SpawnAmmo { get; set; } = null;
    public virtual List<SubclassAbility> Abilities { get; set; } = new ();
